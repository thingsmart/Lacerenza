<?php
	...
	$titolo = ($_GET['nome'] == "nuovo") ? "Nuova Revisione Contrattuale" : "Modifica Revisione Contrattuale";
...
<!--SCRIPT SITO-->
<script src="js/sito/nuova_revisione_contrattuale.js" type="text/javascript"></script>
...
$(document).ready(function() {
	...
	<? if($titolo == "Nuova Revisione Contrattuale"){ ?>
		$("#btn_nuova_revisione_contrattuale").show();	
	<? } else {?>
	...
	<? } ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
		        	...
		        	<div class="col-lg-12">
						<div class="page-title">
							<h1><?=$titolo?> <small></small><a class="close pull-right" href="pagina_revisioni_contrattuali.php?id=<?=$id_commessa?>"><i class="fa fa-backward"></i> Indietro</a></h1>
                ...
                <div class="row">
                    <div class="col-lg-12 ">
                    	<div id="div_nuova_revisione_contrattuale">
                ...
                <!-- /.row -->
				<br>
				<div class="btn btn-success btn-block" id="btn_nuova_revisione_contrattuale" style="display:none"><i class="fa fa-save"></i> Salva e allega</div>
                <div class="btn btn-success btn-block" id="btn_modifica_revisione_contrattuale" style="display:none"><i class="fa fa-save"></i> Salva e allega</div>
            </div>
            <!-- /.container-fluid -->
