...
$esito_ip = ip_in_range($ip_navigazione, "127.0.0.0", "127.0.0.0");
            ...
            <? if($esito_ip == 'OK') { ?>
	            ...
	            <div class="collapse navbar-collapse navbar-ex1-collapse">
	                <ul id="barra_sinistra" class="nav navbar-nav side-nav" style="overflow:auto;">
						...
						<? if($ruolo == "ADMIN" || $ruolo  == "COMMESSA" || $ruolo  == "SUPERADMIN"){ ?>
	                    ...
	                    <? if($ruolo  == "ADMIN" || $ruolo  == "MEZZI" || $ruolo  == "SUPERADMIN"){ ?>
	                    ...
	                    <? if($ruolo  == "ADMIN" || $ruolo == "PERSONALE_RUOLINO" || $ruolo  == "SUPERADMIN"){ ?>
	                    ...
	                    <li <?php if (basename($_SERVER['PHP_SELF']) == "pagina_preventivi.php" || basename($_SERVER['PHP_SELF']) == "pagina_modelli.php" || basename($_SERVER['PHP_SELF']) == "pagina_sezioni.php") {echo 'class="active"'; } ?>>
