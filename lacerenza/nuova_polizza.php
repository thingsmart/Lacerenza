<?php
	...
	$titolo = ($_GET['nome'] == "nuovo") ? "Nuova Polizza" : "Modifica Polizza";
...
<!--SCRIPT SITO-->
<script src="js/sito/nuova_polizza.js" type="text/javascript"></script>
...
$(document).ready(function() {
	...
	<? if($titolo == "Nuova Polizza"){ ?>
		$("#btn_nuova_polizza").show();	
	<? } else {?>
	...
	<? } ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
		        	...
		        	<div class="col-lg-12">
						<div class="page-title">
							<h1><?=$titolo?> <small></small><a class="close pull-right" href="pagina_polizze.php?id=<?=$id_commessa?>"><i class="fa fa-backward"></i> Indietro</a></h1>
                ...
                <!-- /.row -->
				<br>
				<div class="btn btn-success btn-block" id="btn_nuova_polizza" style="display:none"><i class="fa fa-save"></i> Salva e allega</div>
                                 <div class="btn btn-success btn-block" id="btn_modifica_polizza" style="display:none"><i class="fa fa-save"></i> Salva e allega</div>
            </div>
            <!-- /.container-fluid -->
