...
<!--SCRIPT SITO-->
<script src="js/sito/pagina_ordini.js" type="text/javascript"></script>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
					...
					<div class="col-lg-12">
						<div class="page-title">
							<h1>Ordini direzione lavori <small></small><a class="close pull-right" href="pagina_contratti.php?id=<?=$id_commessa?>"><i class="fa fa-backward"></i> Indietro</a></h1>
                ...
                <div class="row">
                	...
                	<div class="col-lg-3">
						<a class="btn btn-success btn-block" href="nuovo_ordine.php?nome=nuovo&id_commessa=<?=$id_commessa?>"><i class="fa fa-plus-circle fa-lg"></i> Aggiungi Ordine</a>
					</div>
                	
                    <div class="col-lg-9">
                    	<div class="input-group">
                      		<input type="text" id="testo_cerca_ordine" placeholder="Cerca per nome file o descrizione" class="form-control">
                      		<span class="input-group-btn">
                        		<button class="btn btn-default" id="cerca_ordine" type="button">cerca</button>
                      		</span>
                    	</div><!-- /input-group -->
                        <br>
