...
//		$data_incasso = $_POST['data_incasso'];
		...
		$e_query_inserimento = $fattura->inserisciFattura($id_commessa, $tipo_documento, $descrizione, $importo_totale, $data_pagamento, $data_incasso, $target_path_inserimento, $filename, $note, $tipologia);

		$_SESSION['ultima_data_pagamento'] = $data_pagamento;
	...
	case "elimina":
		...
		if($e_query_elimina > 0){
			if($nome != ""){
				$target_path = "../uploads/commesse/".$id_commessa."/fatture_materiali_esterni/".$nome;
...
//        $data_incasso = $_POST['data_incasso'];
		...
		$fattura = new MaterialiEsterni();
		$e_query_inserimento = $fattura->modificaFattura($id, $tipo_documento, $descrizione, $importo_totale, $data_pagamento, $data_incasso, $target_path_modifica, $filename, $note, $tipologia);
