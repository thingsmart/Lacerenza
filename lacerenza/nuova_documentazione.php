<?php
	...
	$titolo = ($_GET['nome'] == "nuovo") ? "Nuova Documentazione" : "Modifica Documentazione";
...
<!--SCRIPT SITO-->
<script src="js/sito/nuova_documentazione.js" type="text/javascript"></script>
...
$(document).ready(function() {
	...
	<? if($titolo == "Nuova Documentazione"){ ?>
		$("#btn_nuova_documentazione").show();	
	<? } else {?>
	...
	<? } ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
					...
					<div class="col-lg-12">
						<div class="page-title">
							<h1> <?=$titolo?> <small></small><a class="close pull-right" href="pagina_documentazioni.php?id=<?=$id_commessa?>"><i class="fa fa-backward"></i> Indietro</a></h1>
                ...
                <div class="row">
                    <div class="col-lg-12 ">
                    	<div id="div_nuova_documentazione">
                ...
                <!-- /.row -->
				<br>
				<div class="btn btn-success btn-block" id="btn_nuova_documentazione" style="display:none"><i class="fa fa-save"></i> Salva e allega</div>
                                 <div class="btn btn-success btn-block" id="btn_modifica_documentazione" style="display:none"><i class="fa fa-save"></i> Salva e allega</div>
            </div>
            <!-- /.container-fluid -->
