<?php
	...
	$titolo = ($_GET['nome'] == "nuovo") ? "Nuovo Ordine" : "Modifica Ordine";
...
<!--SCRIPT SITO-->
<script src="js/sito/nuovo_ordine_commessa.js" type="text/javascript"></script>


<script>
$(document).ready(function() {
    $("#div_nuovo_ordine_commessa").load("php/div_nuovo_ordine_commessa.php?id=<?=$id?>&id_commessa=<?=$id_commessa?>");	
	
	<? if($titolo == "Nuovo Ordine"){ ?>
		$("#btn_nuovo_ordine").show();	
	<? } else {?>
	...
	<? } ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
					...
					<div class="col-lg-12">
						<div class="page-title">
							<h1><?=$titolo?> <small></small> <a class="close pull-right" href="pagina_ordini_commessa.php?id=<?=$id_commessa?>"><i class="fa fa-backward"></i> Indietro</a></h1>
                ...
                <div class="row">               	
                    <div class="col-lg-12 ">
                    	<div id="div_nuovo_ordine_commessa">
                ...
                <!-- /.row -->
				<br>
				 <div class="btn btn-success btn-block" id="btn_nuovo_ordine" style="display:none"><i class="fa fa-save"></i> Salva</div>
                                 <div class="btn btn-success btn-block" id="btn_modifica_ordine" style="display:none"><i class="fa fa-save"></i> Salva</div>
            </div>
            <!-- /.container-fluid -->
