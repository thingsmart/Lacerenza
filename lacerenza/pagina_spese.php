...
<!--SCRIPT SITO-->
<script src="js/sito/pagina_spese.js" type="text/javascript"></script>

<script>
$(document).ready(function() {
	$("#tabella_spese").load("php/tabella_spese.php?id=<?=$id_mezzo?>&data_inizio=<?=$data_inizio?>&data_fine=<?=$data_fine?>&targa=<?=$targa?>");	
});
</script>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
			        	...
			        	<div class="col-lg-12">
							<div class="page-title">
								<h1>Altre Spese <small> aggiungi altre spese al veicolo <?=$targa?></small><a class="close pull-right" href="pagina_mezzi.php?data_inizio=<?=$data_inizio?>&data_fine=<?=$data_fine?>"><i class="fa fa-backward"></i> Indietro</a></h1>
								<div class="clearfix"></div>
								<ol class="breadcrumb">
									<li class="active">
										<i class="fa fa-money fa-lg"></i> Spese Varie
									</li>
									<li class="pull-right">
                ...
                <div class="row">
                	<div class="col-lg-2">
                		<a class="btn btn-success btn-block" href="nuova_spesa.php?nome=nuovo&id_mezzo=<?=$id_mezzo?>&data_inizio=<?=$data_inizio?>&data_fine=<?=$data_fine?>&targa=<?=$targa?>"><span class="number-left">+</span> Aggiungi spesa</a>
                		<br>
                	</div>
                	<div class="col-lg-4">
                    ...
                    <div class="col-lg-6">
                    	<div class="input-group">
                      		<input type="text" id="testo_cerca_spesa" placeholder="Cerca per tipo" class="form-control">
