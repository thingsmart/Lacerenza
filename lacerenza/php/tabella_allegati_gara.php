...
$gare = new Gare();
$e_query_callegati = $gare->caricaAllegati($id);

?>

<!--SCRIPT SITO-->
<script src="js/sito/tabella_allegati_gara.js" type="text/javascript"></script>

<?php if($e_query_callegati->num_rows > 0){ ?>
<!--Tabella Allegato-->  
<div>      
  ...
  ?>
  	<tr>
    	...
    	<td style="text-align:center" data-title="Allegato">
        	<a href="uploads/gare/<?=$id?>/<?=$row_allegati['filename']?>" target="_blank">Apri allegato</a>
        </td>
        <td style="text-align:center" data-title="Elimina">
        	<div  type="button" class="btn btn-danger elimina_allegato" id_allegato="<?=$row_allegati['id']?>" id_gara="<?=$row_allegati['id_gara']?>" nome="<?=$row_allegati['filename']?>" data-toggle="modal" data-target=".bs-elimina"> Elimina</div>
        </td>
    </tr>
    <? } ?>
  </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <div id="id_gara_da_eliminare" style="display:none"></div>
