...
$allegati = new AllegatiNoleggio();

if($filtro == ""){
    $e_query_allegati = $allegati->CaricaAllegati($id_noleggio);
} else {
    $e_query_allegati = $allegati->filtraAllegati($filtro, $id_noleggio);
}
$numeroAllegati = $allegati->numeroAllegati();
?>

<!--SCRIPT SITO-->
<script src="js/sito/tabella_allegati_noleggi.js" type="text/javascript"></script>
...
<input type="hidden" value="<?=$id_noleggio?>" id="id_noleggio"/>