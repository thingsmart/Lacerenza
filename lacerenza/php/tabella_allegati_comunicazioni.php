...
<!--SCRIPT SITO-->
<script src="js/sito/tabella_allegati_comunicazioni.js" type="text/javascript"></script>
  ...
  ?>
  	<tr>
    	...
    	<td style="text-align:center" data-title="Allegato">
        	...
        	<button  style="margin-left:3px;" type="button" class="close elimina_allegato" id_allegato="<?=$row_allegati['id']?>" id_comunicazione="<?=$row_allegati['id_comunicazione']?>" nome="<?=$row_allegati['file_name']?>" data-toggle="modal" data-target=".bs-elimina-allegato"> &times;</button>
        </td>
    </tr>
    <? } ?>
  </tbody>
...
<!--Modal elimina-->
<div class="modal <?=$fade?> bs-elimina-allegato" tabindex="-1" role="dialog" id="dialog_elimina" style="display:none" aria-labelledby="myLargeModalLabel" aria-hidden="true">
