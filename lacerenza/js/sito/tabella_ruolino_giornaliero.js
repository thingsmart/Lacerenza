$(document).ready(function() {
    ...
    $("#data").change(function(){
    	...
    	$("#tabella_ruolino_giornaliero").html("<div style='margin:auto; text-align:center'><img src='img/load.gif' /></div>");	
			...
			data: {tipo: "elimina", id:id, data:data_select, id_commessa:id_commessa},
				success: function(data, textStatus, xhr) {
					if(data > 0){
						...
						$("#tabella_ruolino_giornaliero").load("php/tabella_ruolino_giornaliero.php?data="+data_select);
