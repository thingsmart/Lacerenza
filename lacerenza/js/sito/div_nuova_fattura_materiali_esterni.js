		...
		$.ajax({
			...
			success: function (data, textStatus, xhr) {
					if(data >= 0){
						...
						$("#div_nuova_fattura_materiali_esterni").load("php/div_nuova_fattura_materiali_esterni.php?id=" + id + "&id_commessa=" + id_commessa);
		...
		success: function(data){
			...
			if(tipo != "modifica"){
			    if (data >= 0) {
					...
					$("#div_nuova_fattura_materiali_esterni").load("php/div_nuova_fattura_materiali_esterni.php?id=" + data + "&id_commessa=" + id_commessa);
					$("#ul_log").load("php/ul_log.php");	
				}  else {
					alert("Errore: "+data);	
				}
