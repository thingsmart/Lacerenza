$(document).ready(function() {
    ...
    // $("#data").change(function(){
    	// var data = $("#data").val();
    	// $("#tabella_comunicazioni").html("<div style='margin:auto; text-align:center'><img src='img/load.gif' /></div>");	
    	// $("#tabella_comunicazioni").load("php/tabella_comunicazioni.php?data="+data);	
    // });
			...
			data: {tipo: "elimina", id:id},
				success: function(data, textStatus, xhr) {
					if(data > 0){
						...
						$("#tabella_comunicazioni").load("php/tabella_comunicazioni.php?data="+data_select+"&a_data="+a_data_select);
