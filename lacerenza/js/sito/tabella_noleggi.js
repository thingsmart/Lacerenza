$(document).ready(function() {
    ...
    $(".btn_elimina_noleggio").unbind("click");
    $(".btn_elimina_noleggio").click(function () {
        var id_noleggio = $(this).attr("id");
        var nome = $(this).attr("nome");
        $("#id_da_eliminare").val(id_noleggio);
