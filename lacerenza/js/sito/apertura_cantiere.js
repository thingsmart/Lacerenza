...
$(document).ready(function() {
	 ...
	 $("#btn_salva_cantiere").click(function(){
		...
		var pi = $("#pi").val();
		var pec = $("#pec").val();
         var numerodipendenti = $("#numerodipendenti").val();
        ...
        type: 'POST',
        data: {id:id, email:email, pi:pi, pec:pec, indirizzo_referente:indirizzo_referente, cantiere:cantiere, localita:localita, importo:importo, tipologia_lavori:tipologia_lavori, referente:referente, telefono:telefono, fax:fax, cellulare:cellulare, data_inizio:data_inizio, datafine:data_fine, numerodipendenti:numerodipendenti, aperturacantiere:"1"},
