$(document).ready(function() {
    ...
    $(".btn_elimina_personale").unbind("click");
    $(".btn_elimina_personale").click(function () {
        var id_personale = $(this).attr("id");
        var nome = $(this).attr("nome");
        $("#id_da_eliminare").val(id_personale);
	...
	$("#btn_elimina_conferma").click(function(){
		...
		$.ajax({
			url: "lib/operazioni_personale.lib.php",
			type: 'POST',
