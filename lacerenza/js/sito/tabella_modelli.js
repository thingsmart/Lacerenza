$(document).ready(function() {
	...
	$("#btn_elimina_conferma").click(function(){
		...
		$.ajax({
			url: "lib/operazioni_modello_master.lib.php",
			type: 'POST',
    ...
    $(".btn_riepilogo").unbind("click");
    $(".btn_riepilogo").click(function () {
    	
        var testo = $(this).attr("testodescrittivo");
		$("#testo_riepilogo").html(testo);
