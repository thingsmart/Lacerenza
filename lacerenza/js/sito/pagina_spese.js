...
$(document).ready(function() {
    ...
    $("#data_inizio").change(function(){
    	...
    	$("#tabella_spese").html("<div style='margin:auto; text-align:center'><img src='img/load.gif' /></div>");	
    	$("#tabella_spese").load("php/tabella_spese.php?id=" + id + "&data_inizio="+data_inizio+"&data_fine="+data_fine);	
    });
    ...
    $("#cerca_spesa").click(function () {
		...
		$("#tabella_spese").load("php/tabella_spese.php?id=" + id_mezzo + "&filtro_spesa=" + filtro_spesa + "&data_inizio="+data_inizio+"&data_fine="+data_fine);
	});//chiudo $("#cerca_utente")
