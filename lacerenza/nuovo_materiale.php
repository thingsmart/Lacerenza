<?php
	...
	$titolo = ($_GET['nome'] == "nuovo") ? "Nuovo Materiale" : "Modifica Materiale";
...
<!--SCRIPT SITO-->
<script src="js/sito/nuovo_materiale.js" type="text/javascript"></script>
...
$(document).ready(function() {
	...
	<? if($titolo == "Nuovo Materiale"){ ?>
		$("#btn_nuovo_materiale").show();	
	<? } else {?>
	...
	<? } ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
			        	...
			        	<div class="col-lg-12">
							<div class="page-title">
								<h1><?=$titolo?> <small> aggiungi materiale</small><a class="close pull-right" href="pagina_materiali.php?id=<?=$id_commessa?>"><i class="fa fa-backward"></i> Indietro</a></h1>
								<div class="clearfix"></div>
								<ol class="breadcrumb">
									<li class="active">
										<i class="fa fa-tags fa-lg"></i> Materiale
									</li>
									<li class="pull-right">
                ...
                <!-- /.row -->
				<br>
				 <div class="btn btn-success btn-block" id="btn_nuovo_materiale" style="display:none"><i class="fa fa-save"></i> Salva e allega</div>
                                 <div class="btn btn-success btn-block" id="btn_modifica_materiale" style="display:none"><i class="fa fa-save"></i> Salva e allega</div>
            </div>
            <!-- /.container-fluid -->
