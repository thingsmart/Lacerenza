...
<!--SCRIPT SITO-->
<script src="js/sito/pagina_gara.js" type="text/javascript"></script>
...
<script>
$(document).ready(function() {
	$("#titolo_page").html("Lacerenza | Gare");
});
</script>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
		        	...
		        	<div class="col-lg-12">
						<div class="page-title">
							<h1>Gare <small>scheda gare </small> <a class="close pull-right" href="pagina_tecnica_prima.php"><i class="fa fa-backward"></i> Indietro</a></h1>
							<ol class="breadcrumb">
								<li class="active">
									<i class="fa fa-suitcase fa-lg"></i> Gare
								</li>
								<li class="pull-right">
                ...
                <div class="row">
                	<div class="col-lg-3">
                		<a class="btn btn-success btn-block" href="nuova_gara.php?nome=nuovo"><i class="fa fa-plus-circle fa-lg"></i> Aggiungi Gara</a>
                		<br>
                	</div>
                	<div class="col-lg-3">
                    ...
                    <div class="col-lg-12 ">                    	
                        <br>
                    	<div id="tabella_gara" style="overflow: auto">
...
<div class="modal <?=$fade?> bs-elimina" tabindex="-1" role="dialog" id="dialog_elimina" style="display:none" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" id="modal_body" > Sei sicuro di voler eliminare la gara? </div>
