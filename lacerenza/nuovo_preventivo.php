	        ...
	        <div class="row">
				...
				<div class="col-lg-12">
					<div class="page-title">
						<h1><?=$titolo?> <small></small> <a class="btn btn-default pull-right" href="pagina_riepilogo_preventivi.php"><i class="fa fa-arrow-left"></i> Indietro</a></h1>
						<div class="clearfix"></div>
						<ol class="breadcrumb">
							<li class="active">
								<i class="fa fa-file-pdf-o fa-lg"></i> Preventivi -> <?=$titolo?>
							</li>
							<li class="pull-right">
