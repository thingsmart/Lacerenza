    ...
    $("#tabella_revisioni_contrattuali").load("php/tabella_revisioni_contrattuali.php?id=<?=$id_commessa?>");	
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
		        	...
		        	<div class="col-lg-12">
						<div class="page-title">
							<h1>Revisioni Contrattuali <small></small><a class="close pull-right" href="pagina_contratti.php?id=<?=$id_commessa?>"><i class="fa fa-backward"></i> Indietro</a></h1>
                ...
                <div class="row">
                	<div class="col-lg-3">
                		<a class="btn btn-success btn-block" href="nuova_revisione_contrattuale.php?nome=nuovo&id_commessa=<?=$id_commessa?>"><i class="fa fa-plus-circle fa-lg"></i> Aggiungi Revisione</a>
                	</div>
                    <div class="col-lg-9">
                ...
                <!-- /.row -->
				<br>
				<div id="tabella_revisioni_contrattuali">
