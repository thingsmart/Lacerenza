...
require_once("lib/verificaConvertiData.php");
	...
	$titolo = ($_GET['nome'] == "nuovo") ? "Aggiungi Comunicazione" : "Modifica Comunicazione";
?>


<!--SCRIPT SITO-->
<script src="js/sito/nuova_comunicazione.js" type="text/javascript"></script>
...
$(document).ready(function() {
	...
	<? if($titolo == "Aggiungi Comunicazione"){ ?>
		$("#btn_nuovo").show();	
	<? } else {?>
		$("#btn_modifica").show();	
	<? } ?>
                	...
                	<!-- TITOLO -->
						<div class="col-lg-12">
							<div class="page-title">
								<h1><?=$titolo?> <small></small> <a class="close pull-right" href="comunicazioni.php?data=<?=$data_indietro?>&a_data=<?=$a_data_indietro?>"><i class="fa fa-backward"></i> Indietro</a></h1>
