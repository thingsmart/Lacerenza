...
<!--SCRIPT SITO-->
<script src="js/sito/nuova_spesa.js" type="text/javascript"></script>


<script>
$(document).ready(function() {
    $("#div_nuova_spesa").load("php/div_nuova_spesa.php?id=<?=$id?>&id_mezzo=<?=$id_mezzo?>");	
                ...
                <div class="row">
			        	...
			        	<div class="col-lg-12">
							<div class="page-title">
								<h1><?=$titolo?> <small> inserisci spesa relativa al veicolo <?=$targa?></small> <a class="close pull-right" href="pagina_spese.php?id=<?=$id_mezzo?>&data_inizio=<?=$data_inizio?>&data_fine=<?=$data_fine?>&targa=<?=$targa?>"><i class="fa fa-backward"></i> Indietro</a></h1>
								<div class="clearfix"></div>
								<ol class="breadcrumb">
									<li class="active">
										<i class="fa fa-dashboard fa-lg"></i> Spesa
									</li>
									<li class="pull-right">
