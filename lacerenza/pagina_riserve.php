...
<!--SCRIPT SITO-->
<script src="js/sito/pagina_riserve.js" type="text/javascript"></script>
            ...
            <div class="container-fluid">
				...
				<div class="col-lg-12">
					<div class="page-title">
						<h1>Riserve <small></small> <a class="close pull-right" href="pagina_contratti.php?id=<?=$id_commessa?>"><i class="fa fa-backward"></i> Indietro</a></h1>
                ...
                <div class="row">
                	<div class="col-lg-3">
						<a class="btn btn-success btn-block" href="nuova_riserva.php?nome=nuovo&id_commessa=<?=$id_commessa?>"><i class="fa fa-plus-circle fa-lg"></i> Aggiungi Riserva</a>
					</div>

                    <div class="col-lg-9">
                    	<div class="input-group">
                      		<input type="text" id="testo_cerca_riserva" placeholder="Cerca per descrizione, dettagli o nome allegato" class="form-control">
                      		<span class="input-group-btn">
                        		<button class="btn btn-default" id="cerca_riserva" type="button">cerca</button>
                      		</span>
                    	</div><!-- /input-group -->
                        <br>
...
<div class="modal <?=$fade?> bs-elimina" tabindex="-1" role="dialog" id="dialog_elimina" style="display:none" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" id="modal_body" > Sei sicuro di voler eliminare la riserva? </div>
