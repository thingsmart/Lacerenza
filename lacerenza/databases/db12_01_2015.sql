...
AUTO_INCREMENT=16 AVG_ROW_LENGTH=16384 CHARACTER SET 'latin1' COLLATE 'latin1_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=1852 AVG_ROW_LENGTH=213 CHARACTER SET 'latin1' COLLATE 'latin1_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=7 AVG_ROW_LENGTH=5461 CHARACTER SET 'latin1' COLLATE 'latin1_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=25 AVG_ROW_LENGTH=4096 CHARACTER SET 'latin1' COLLATE 'latin1_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=23 AVG_ROW_LENGTH=4096 CHARACTER SET 'latin1' COLLATE 'latin1_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=4 AVG_ROW_LENGTH=16384 CHARACTER SET 'latin1' COLLATE 'latin1_general_ci'
COMMENT=''
;
...
#
# Data for the `tb_allegati_comunicazioni` table  (LIMIT -498,500)
#
...
#
# Data for the `tb_comunicazioni` table  (LIMIT -498,500)
#
...
#
# Data for the `tb_log` table  (LIMIT -84,500)
#
...
#
# Data for the `tb_magazzino` table  (LIMIT -496,500)
#

INSERT INTO `tb_magazzino` (`id`, `data`, `mezzo`, `id_mezzo`, `id_commessa`, `descrizione_commessa`, `materiale`, `quantita`, `utente`, `firma`) VALUES

  (1,'2015-01-12','aaa',1,1,'aaa','sssss','7','admin','user'),
  (4,'0000-00-00','',0,0,'','','','admin',NULL),
  (5,'2015-01-12','Clio',1,6,'Casa_Della_Salute','cemento','34','admin',NULL);
COMMIT;
...
#
# Data for the `tb_ruolino` table  (LIMIT -495,500)
#
...
INSERT INTO `tb_ruolino` (`id`, `id_commessa`, `cod_commessa`, `descrizione_commessa`, `localizzazione_lavoro`, `quantita`, `addetti`, `ore`, `mezzo`, `km`, `autista`, `terzi`, `ore_terzi`, `note`, `data`, `utente`, `cod_lavoro`, `descrizione_lavoro`, `codizioni_climatiche`, `id_lavoro`, `id_dipendenti`, `id_mezzo`, `clima`, `tipologia`) VALUES
  ...
  (22,6,'001','Casa_Della_Salute',NULL,'100',' Rossi Mario, Bianchi Franco','8',NULL,NULL,'Rossi Mario','','','','2015-01-12','admin','1','verifica del massetto esistente (IMPERMEABILIZZAZIONI scheda n. 01)',NULL,5,'5 ,6 ',NULL,'NUVOLOSO','cap');
COMMIT;
...
#
# Data for the `tb_veicoli` table  (LIMIT -498,500)
#
