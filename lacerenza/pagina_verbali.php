...
<!--SCRIPT SITO-->
<script src="js/sito/pagina_verbali.js" type="text/javascript"></script>
    ...
    $("#tabella_verbali").load("php/tabella_verbali.php?id=<?=$id_commessa?>");	
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
		        	...
		        	<div class="col-lg-12">
						<div class="page-title">
							<h1>Gestione Verbali Lavoro <small></small><a class="close pull-right" href="pagina_contratti.php?id=<?=$id_commessa?>"><i class="fa fa-backward"></i> Indietro</a></h1>
                ...
                <div class="row">
                	<div class="col-lg-3">
                		 <a class="btn btn-success btn-block" href="nuovo_verbale.php?nome=nuovo&id_commessa=<?=$id_commessa?>"><i class="fa fa-plus-circle fa-lg"></i> Aggiungi Verbale</a>
                	</div>
                    <div class="col-lg-9">
                    	<div class="input-group">
                      		<input type="text" id="testo_cerca_verbale" placeholder="Cerca per descrizione" class="form-control">
                      		<span class="input-group-btn">
                        		<button class="btn btn-default" id="cerca_verbale" type="button">cerca</button>
                      		</span>
                    	</div><!-- /input-group -->
                        <br>
...
<div class="modal <?=$fade?> bs-elimina" tabindex="-1" role="dialog" id="dialog_elimina" style="display:none" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" id="modal_body" > Sei sicuro di voler eliminare il verbale? </div>
