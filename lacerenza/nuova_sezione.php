<?php
	...
	$titolo = ($_GET['nome'] == "nuovo") ? "Nuova Sezione" : "Modifica Sezione";
?>
	        ...
	        <div class="row">
				...
				<div class="col-lg-12">
					<div class="page-title">
						<h1><?=$titolo?> <small></small> <a class="btn btn-default pull-right" href="pagina_sezioni.php"><i class="fa fa-arrow-left"></i> Indietro</a></h1>
						<div class="clearfix"></div>
						<ol class="breadcrumb">
							<li class="active">
								<i class="fa fa-file-pdf-o fa-lg"></i> Preventivi -> Nuova Sezione
							</li>
							<li class="pull-right">
