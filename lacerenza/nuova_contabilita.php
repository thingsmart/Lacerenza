<?php
	...
	$titolo = ($_GET['nome'] == "nuovo") ? "Nuova Contabilit&agrave;" : "Modifica Contabilit&agrave;";
...
<!--SCRIPT SITO-->
<script src="js/sito/nuova_contabilita.js" type="text/javascript"></script>
                ...
                <div class="row">
		        	...
		        	<div class="col-lg-12">
						<div class="page-title">
							<h1><?=$titolo?><small></small><a class="close pull-right" href="pagina_contabilita_new.php?id=<?=$id_commessa?>"><i class="fa fa-backward"></i> Indietro</a></h1>
