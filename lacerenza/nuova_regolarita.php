<?php
	...
	$titolo = ($_GET['nome'] == "nuovo") ? "Nuova Regolarit&agrave;" : "Modifica Regolarit&agrave;";
...
<!--SCRIPT SITO-->
<script src="js/sito/nuova_regolarita.js" type="text/javascript"></script>
...
$(document).ready(function() {
	...
	<? if($titolo == "Nuova Regolarit&agrave;"){ ?>
		$("#btn_nuova_regolarita").show();	
	<? } else {?>
	...
	<? } ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
					...
					<div class="col-lg-12">
						<div class="page-title">
							<h1><?=$titolo?> <small></small> <a class="close pull-right" href="pagina_regolarita.php?id=<?=$id_commessa?>"><i class="fa fa-backward"></i> Indietro</a></h1>
							<ol class="breadcrumb">
							<li class="active">
                ...
                <!-- /.row -->
				<br>
				<div class="btn btn-success btn-block" id="btn_nuova_regolarita" style="display:none"><i class="fa fa-save"></i> Salva e allega</div>
                                 <div class="btn btn-success btn-block" id="btn_modifica_regolarita" style="display:none"><i class="fa fa-save"></i> Salva e allega</div>
            </div>
            <!-- /.container-fluid -->
